                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="index.html">
                            ...
                            <img alt="" src="images/compnay_logo.png" class="mt-6-up">
                              <div class="tag-line">Secure Assessment Solutions</div>
                        </a>
                    </div>
                    <div class="navbar-collapse collapse">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                              ...
                              <li><a href="#" data-toggle="modal" data-target="#myModal" style="    background: #31bb31;
                    ...
                    <div class="item active">
                        ...
                        <div class="slider-content ">
                            <div class="col-md-12 shift-text " style="margin-left: 5%;">
                                ...
                                <h3 class="animated3" style="display:none">
                            		<span>Incredible features and options making it easy for the <br><br> user to Create, Share and Analyze the online test</span>
                            	</h3>
          ...
          <div class="row">
                    ...
                    <div>
                        <div class="service-icon">
                          <img src="http://novamantic.cresol.in/images/mission/corporate_misson.png" style="
    max-width: 16%;
">
                        </div>
                    ...
                    <div class="col-md-6 service-box service-center animated fadeIn delay-02" data-animation="fadeIn" data-animation-delay="02">
                     <div  class="value-box">
                        <div class="service-icon">
                          <img src="http://novamantic.cresol.in/images/mission/corporate_vision.png" style="
    max-width: 16%;
">
                        </div>
                        <div class="service-content">
...
<div class="section purchase-3 testimonial-area" id="Div1">
    ...
    <p style="text-align: center;">Desc. Desc. Desc. Desc. Desc. Desc. Desc. Desc. Desc. Desc.</p>
     ...
     <button type="button" class="btn send-button pull-right btn-lg"  >Send Message</button>
      ...
      <div class="col-md-12"><i class="fa fa-phone"></i>&nbsp;&nbsp;+91-8860905089&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-envelope"></i>&nbsp;&nbsp;novamantic@gmail.com
